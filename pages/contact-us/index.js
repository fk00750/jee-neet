...
import { IoCallOutline, IoLocation, IoLocationOutline, IoLogoWhatsapp, IoMail, IoMailOutline } from 'react-icons/io5';
            ...
            <div className='col-md-7 pe-md-5 pe-0 ps-0'>
              <div className='row'>
                <div className='col-md-6 mt-3'>
                  <div className={`${styles.contact_card} card border-0 bg-background h-100 p-3 py-4`}>
                    <div className='d-flex justify-content-center mb-4 mt-3'>
                      <IoCallOutline size={32} />
                    </div>
                    <h5 className='text-center'>Call Us</h5>
                    <p className='text-center'><small>(+91) 9696330033</small></p>
                  </div>
                </div>
                <div className='col-md-6 mt-3'>
                  <div className={`${styles.contact_card} card border-0 bg-background h-100 p-3 py-4`}>
                ...
                <div className='col-md-6 mt-3'>
                  <div className={`${styles.contact_card} card border-0 bg-background h-100 p-3 py-4`}>
                    ...
                    <p className='text-center'><small>support@majorkalshiclasses.com</small></p>
                  </div>
                </div>
                <div className='col-md-6 mt-3'>
                  <div className={`${styles.contact_card} card border-0 bg-background h-100 p-3 py-4`}>
                    ...
                    <p className='text-center'><small>Shapath Building, Tagore Town, Prayagraj, Uttar Pradesh</small></p>
                  </div>
                </div>
              </div>
            </div>
